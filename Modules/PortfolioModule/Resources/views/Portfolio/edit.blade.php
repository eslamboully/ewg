            ...
            <div class="tab-content">
              ...
              <div class="tab-pane @if($loop->first) active @endif" id="{{ $lang->display_lang }}">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                      {{-- Description --}}
                      <label class="control-label col-sm-2" for="title">{{__('portfoliomodule::portfolio.short_desc')}}
                          ({{$lang->display_lang}}):</label>
                      <div class="col-sm-8">
                    <textarea id="short{{$lang->id}}" name="{{$lang->lang}}[short_desc]"
                              style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ ValueOf($project,$lang,'short_desc') }}
                    </textarea>
                      </div>
                  </div>

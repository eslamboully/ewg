...
Route::group(['prefix' => 'admin-panel', 'middleware' => ['auth:admin']], function () {
    Route::prefix('portfoliomodule')->group(function () {
        ...
        Route::group(['middleware' => ['role:admin|superadmin|owner']], function () {
            ...
            Route::get('project/{id}/photos', 'PortfolioController@photosGet');
            Route::get('project/{id}/deletess', 'PortfolioController@photosDelete')->name('project.delete.photo');
            Route::post('project/photo/add', 'PortfolioController@photosAdd')->name('photo.special.add');
        });
